  ...
  return (
    <PhoneShell title="الملف الشخصي">
      <div className="rounded-2xl bg-white p-6 shadow-sm">
        {/* قسم الصورة الشخصية المنسق */}
        <div className="flex flex-col items-center border-b border-slate-100 pb-6">
          <div className="relative h-24 w-24 overflow-hidden rounded-full border-2 border-[#1ea0df] flex items-center justify-center bg-slate-50">
            {user?.image ? (
              <Image
                src={user?.image}
                alt="profile"
          ...
          {/* عرض الاسم الحقيقي للمستخدم مع وضع خيار بديل في حال لم يتوفر */}
